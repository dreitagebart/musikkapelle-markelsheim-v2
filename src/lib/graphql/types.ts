...
/** The event type */
export type Event = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithTemplate & NodeWithTitle & UniformResourceIdentifiable & {
  __typename?: 'Event';
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Datumsinformationen&quot; was set to Show in GraphQL. */
  add_info?: Maybe<Event_AddInfo>;
...
/** Field Group */
export type Event_AddInfo = AcfFieldGroup & {
  __typename?: 'Event_AddInfo';
...
export type MenuItemObjectUnion = Category | Event | New | Page | Post | Tag;
...
export enum MenuLocationEnum {
  /** Put the menu in the footer-menu-1 location */
  FooterMenu_1 = 'FOOTER_MENU_1',
  /** Put the menu in the header-menu-1 location */
  HeaderMenu_1 = 'HEADER_MENU_1',
  /** Put the menu in the header-mobile-menu location */
  HeaderMobileMenu = 'HEADER_MOBILE_MENU'
}
...
/** The new type */
export type New = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithTemplate & NodeWithTitle & UniformResourceIdentifiable & {
  __typename?: 'New';
  /** The content of the post. */
  content?: Maybe<Scalars['String']>;
  /** Connection between the ContentNode type and the ContentType type */
...
/** Connection between the new type and the new type */
export type NewToPreviewConnectionEdge = {
...
/** Connection between the RootQuery type and the new type */
export type RootQueryToNewConnection = {
  __typename?: 'RootQueryToNewConnection';
  /** Edges for the RootQueryToNewConnection connection */
  edges?: Maybe<Array<Maybe<RootQueryToNewConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<New>>>;
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>;
};

/** An edge in a connection */
export type RootQueryToNewConnectionEdge = {
...
/** The template assigned to the node */
export type Template_ThemePageBuilder = ContentTemplate & {
  __typename?: 'Template_ThemePageBuilder';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']>;
};

/** The template assigned to the node */
export type Template_ThemePageBuilderWithContainer = ContentTemplate & {
  __typename?: 'Template_ThemePageBuilderWithContainer';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']>;
};
