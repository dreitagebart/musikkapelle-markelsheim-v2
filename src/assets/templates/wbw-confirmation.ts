    ...
    <mj-section background-color="#ffffff">
      <mj-column>
        <mj-text font-size="22px" color="#1A202C" font-family="arial"
          >Ihre Anmeldung zur Weinbergwanderung</mj-text
        >
        <mj-text font-size="16px" color="#1A202C" font-family="arial"
          >Hiermit bestätigen wir Ihnen den Eingang der Anmeldung. Die
          Weinbergwanderung findet am Sonntag, 22.09.2024 um 14:00 Uhr am
          Tauberberg Markelsheim (Auffahrt Richtung Elpersheim) statt.
        </mj-text>
        <mj-text font-size="16px" color="#1A202C" font-family="arial">
          Sollten Sie kurzfristig nicht an der Weinbergwanderung teilnehmen
